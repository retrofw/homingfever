...
TARGET		?= homingfever/homingfever.elf
SRCDIR		:= src
OBJDIR		:= obj
...
ipk: all
	...
	@cp -r homingfever/data homingfever/homingfever.elf homingfever/homingfever.lnk homingfever/homingfever.man.txt homingfever/homingfever.png /tmp/.homingfever-ipk/root/home/retrofw/games/homingfever
